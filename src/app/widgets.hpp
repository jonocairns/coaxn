...
enum class Icon {
    Play, Pause, Stop, VolumeMuted, VolumeLow, VolumeHigh, Settings,
    // The window controls, for the strip that stands in for a title bar.
    Minimise, Fullscreen, FullscreenExit, Close,
};
